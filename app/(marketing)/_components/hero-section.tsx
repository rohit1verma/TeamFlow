...
import ArcjetLogo from "@/public/companies/arcjet.svg";
import KindeLogo from "@/public/companies/GitHubLogo.png"
...
import OpenAiLogo from "@/public/companies/OpenAiLogo.png"
          ...
          <div className='relative pt-24 md:pt-36'>
            ...
            <div className='mx-auto max-w-7xl px-6'>
              <div className='text-center sm:mx-auto lg:mr-auto lg:mt-0'>
                ...
                >
                  TailFlow organizes conversations into channels with threads, is realtime ans uses AI to keep teams in sync.
                </TextEffect>
        ...
        <section className='bg-background pb-16 pt-16 md:pb-32'>
          <div className='group relative m-auto max-w-5xl px-6'>
            ...
            <div className='group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14'>
              ...
              <div className='flex'>
                <Image
                  className='mx-auto h-10 w-fit invert dark:invert-0'
                  src={MotionLogo}
                  alt='Motion Logo'
